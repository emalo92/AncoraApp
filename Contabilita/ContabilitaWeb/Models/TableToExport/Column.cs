...
namespace ContabilitaWeb.Models.TableToExport
{
    ...
    public class Column
    {
        ...
        /// </summary>
        public TableExportConfig ColumnConfiguration { get; set; }
        ...
        /// <returns></returns>
        public static Column ConvertToColumn(string name, int indexOrder, List<List<object>> elements, TableExportConfig columnConfiguration)
        {
