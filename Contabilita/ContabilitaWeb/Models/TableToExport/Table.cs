...
using System.Linq;
using ContabilitaWeb.Models.Interfaces;
using ContabilitaWeb.ExtensionMethods;
...
namespace ContabilitaWeb.Models.TableToExport
{
    public class Table : IConvertToTableExport
    {
        ...
        /// </summary>
        public List<TableExportConfig> ColumnsConfig { get; set; }
        ...
        public void AddColumn(string tableName, string columnName, int originalIndexOrder)
        {
            ...
            {
                ColumnsConfig = new List<TableExportConfig>();
            }
